...
The text classification analysis based on Random Forest, Naive Bayes, and XGBoost effectively categorized an email as spam or ham. I had difficulies on loading and unzipping the file format in Github.  
